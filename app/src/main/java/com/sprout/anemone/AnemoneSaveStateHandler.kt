...
class AnemoneSaveStateHandler {
    private val handledDialogs: SparseArray<WeakReference<AbsAnemoneDialog<*, *>?>> = SparseArray()
    ...
    fun handleDialogStateSave(id: Int, dialog: AbsAnemoneDialog<*, *>?) {
